...
$sql = "INSERT INTO candidates (district, block, area_type, guardian_aadhar, candidate_name, candidate_aadhar, dob, gender, caste, mother_name, father_name, relation, account_no, ifsc, qualification, contact_no) 
        VALUES ('$district', '$block', '$area_type', '$guardian_aadhar', '$candidate_name', '$candidate_aadhar', '$dob', '$gender', '$caste', '$mother_name', '$father_name', '$relation', '$account_no', '$ifsc', '$qualification', '$contact_no')";
